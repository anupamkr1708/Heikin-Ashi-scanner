...
def main(argv: list[str] | None = None) -> int:
    ...
    p.add_argument("--no-availability-check", action="store_true",
    ...
    result = ingest_session(date.fromisoformat(args.date), store, cfg.paths.raw_dir,
                             check_availability_first=not args.no_availability_check)
